...
class OpsRuntimeConfigResponse(BaseModel):
    ...
    background_artifact_worker_enabled: bool
    ...
    background_artifact_worker_interval_seconds: int
    background_artifact_worker_claim_limit: int
    background_artifact_worker_lease_seconds: int
    background_artifact_worker_max_attempts: int
    background_artifact_input_char_limit: int
    background_artifact_output_char_limit: int
