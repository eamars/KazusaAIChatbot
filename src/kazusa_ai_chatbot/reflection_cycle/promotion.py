  ...
  "evidence_cards": [
    {
      ...
      "active_character_utterance": "角色原文片段",
...
ReflectionPromotionDecision 字段：
{
  ...
  "sanitized_memory_name": "简体中文记忆标题",
  "sanitized_content": "简体中文去隐私内容",
...
def build_global_promotion_prompt(
    ...
    prompt = build_prompt_result(
        system_prompt=GLOBAL_PROMOTION_SYSTEM_PROMPT,
    ...
    *,
    ...
    payload: GlobalPromotionPromptPayload = {
        ...
        "review_questions": [
            ...
            "哪些内容只应成为角色未来回应方式的 self_guidance？",
