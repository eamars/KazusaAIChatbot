...
COGNITION_LLM_REQUIRED_SELECTION_VERIFIER_BASE_URL = os.environ[
    "COGNITION_LLM_REQUIRED_SELECTION_VERIFIER_BASE_URL"
]
COGNITION_LLM_REQUIRED_SELECTION_VERIFIER_API_KEY = os.environ[
    "COGNITION_LLM_REQUIRED_SELECTION_VERIFIER_API_KEY"
]
COGNITION_LLM_REQUIRED_SELECTION_VERIFIER_MODEL = os.environ[
...
COGNITION_LLM_GOAL_ACTIVE_BRANCH_MAX_COMPLETION_TOKENS = _positive_int_from_env(
...
COGNITION_LLM_REQUIRED_SELECTION_VERIFIER_THINKING_ENABLED = _bool_from_env(
    "COGNITION_LLM_REQUIRED_SELECTION_VERIFIER_THINKING_ENABLED",
    "false",
)
COGNITION_LLM_WORKSPACE_COLLAPSE_MAX_COMPLETION_TOKENS = _positive_int_from_env(
...
COGNITION_LLM_ACTION_PLANNING_MAX_COMPLETION_TOKENS = _positive_int_from_env(
