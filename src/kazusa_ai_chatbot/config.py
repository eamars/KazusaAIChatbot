...
def _capped_int_from_env(
    name: str,
    default: str,
    *,
    maximum: int,
) -> int:
    """Read a positive integer and cap it at the owning stage ceiling."""

    return min(
        _positive_int_from_env(name, default),
        maximum,
    )
...
COGNITION_LLM_CHARACTER_CARRYOVER_BASE_URL = os.environ[
    "COGNITION_LLM_CHARACTER_CARRYOVER_BASE_URL"
]
COGNITION_LLM_CHARACTER_CARRYOVER_API_KEY = os.environ[
    "COGNITION_LLM_CHARACTER_CARRYOVER_API_KEY"
]
COGNITION_LLM_CHARACTER_CARRYOVER_MODEL = os.environ[
...
def get_cognition_v3_route_settings() -> CognitionV3RouteSettingsV1:
    """Return the validated V3 route settings loaded at import time."""
...
BACKGROUND_WORK_LLM_BASE_URL = os.environ["BACKGROUND_WORK_LLM_BASE_URL"]
BACKGROUND_WORK_LLM_API_KEY = os.environ["BACKGROUND_WORK_LLM_API_KEY"]
BACKGROUND_WORK_LLM_MODEL = os.environ["BACKGROUND_WORK_LLM_MODEL"]
...
CODING_AGENT_ACTION_LOOP_LLM_BASE_URL = os.getenv(
    "CODING_AGENT_ACTION_LOOP_LLM_BASE_URL",
    "",
).strip()
CODING_AGENT_ACTION_LOOP_LLM_API_KEY = os.getenv(
    "CODING_AGENT_ACTION_LOOP_LLM_API_KEY",
    "",
).strip()
CODING_AGENT_ACTION_LOOP_LLM_MODEL = os.getenv(
    "CODING_AGENT_ACTION_LOOP_LLM_MODEL",
    "",
).strip()
CODING_AGENT_WORKSPACE_ROOT = os.getenv("CODING_AGENT_WORKSPACE_ROOT", "").strip()
CODING_AGENT_PREFLIGHT_EXECUTION = _bool_from_env(
    "CODING_AGENT_PREFLIGHT_EXECUTION",
    "false",
)
CODING_AGENT_REPAIR_MAX_CALLS = _bounded_int_from_env(
    "CODING_AGENT_REPAIR_MAX_CALLS",
    "4",
    minimum=1,
    maximum=6,
)
CODING_AGENT_REPAIR_BUNDLE_CHAR_LIMIT = _positive_int_from_env(
    "CODING_AGENT_REPAIR_BUNDLE_CHAR_LIMIT",
    "6000",
)
CODING_AGENT_REPAIR_TOTAL_BUNDLE_CHAR_LIMIT = _positive_int_from_env(
...
FRONTLINE_RELEVANCE_MAX_INPUT_CHARS = _bounded_int_from_env(
    "FRONTLINE_RELEVANCE_MAX_INPUT_CHARS",
    "8000",
    minimum=1000,
    maximum=8000,
)
SETTLED_RELEVANCE_MAX_INPUT_CHARS = _bounded_int_from_env(
    "SETTLED_RELEVANCE_MAX_INPUT_CHARS",
    "16000",
    minimum=2000,
    maximum=16000,
)
SETTLED_RELEVANCE_MAX_COMPLETION_TOKENS = _bounded_int_from_env(
...
MEDIA_SESSION_CACHE_MAX_ITEMS_PER_SCOPE = _positive_int_from_env(
    "MEDIA_SESSION_CACHE_MAX_ITEMS_PER_SCOPE",
    "8",
)
MEDIA_SESSION_CACHE_MAX_BYTES_PER_SCOPE = _positive_int_from_env(
    "MEDIA_SESSION_CACHE_MAX_BYTES_PER_SCOPE",
    str(16 * 1024 * 1024),
)
MEDIA_SESSION_CACHE_MAX_ITEM_BYTES = _positive_int_from_env(
    "MEDIA_SESSION_CACHE_MAX_ITEM_BYTES",
    str(6 * 1024 * 1024),
)
MEDIA_SESSION_CACHE_TTL_SECONDS = _positive_int_from_env(
...
COGNITION_LLM_MAX_COMPLETION_TOKENS = _capped_int_from_env(
...
CODING_AGENT_ACTION_LOOP_LLM_MAX_COMPLETION_TOKENS = _positive_int_from_env(
    "CODING_AGENT_ACTION_LOOP_LLM_MAX_COMPLETION_TOKENS",
    str(DEFAULT_LLM_MAX_COMPLETION_TOKENS),
)
CODING_AGENT_ACTION_LOOP_LLM_THINKING_ENABLED = _bool_from_env(
...
GROUP_SCENE_MAX_TURN_AGE_MINUTES = _positive_int_from_env(
    "GROUP_SCENE_MAX_TURN_AGE_MINUTES",
    "120",
)
CONVERSATION_PROGRESS_BACKGROUND_MAX_AGE_MINUTES = _positive_int_from_env(
    "CONVERSATION_PROGRESS_BACKGROUND_MAX_AGE_MINUTES",
    "120",
)
CONVERSATION_PROGRESS_ACTIVE_SCENE_MAX_AGE_MINUTES = _positive_int_from_env(
...
CONVERSATION_PROGRESS_NARRATIVE_MAX_AGE_MINUTES = _positive_int_from_env(
...
# Background work runs as asynchronous worker-subagent jobs.
BACKGROUND_WORK_WORKER_ENABLED = _bool_from_env(
    "BACKGROUND_WORK_WORKER_ENABLED",
    "true",
)
BACKGROUND_WORK_WORKER_INTERVAL_SECONDS = _positive_int_from_env(
    "BACKGROUND_WORK_WORKER_INTERVAL_SECONDS",
    "45",
)
BACKGROUND_WORK_WORKER_CLAIM_LIMIT = _positive_int_from_env(
    "BACKGROUND_WORK_WORKER_CLAIM_LIMIT",
    "2",
)
BACKGROUND_WORK_WORKER_LEASE_SECONDS = _positive_int_from_env(
    "BACKGROUND_WORK_WORKER_LEASE_SECONDS",
    "180",
)
BACKGROUND_WORK_WORKER_MAX_ATTEMPTS = _positive_int_from_env(
    "BACKGROUND_WORK_WORKER_MAX_ATTEMPTS",
    "4",
)
BACKGROUND_WORK_INPUT_CHAR_LIMIT = _positive_int_from_env(
    "BACKGROUND_WORK_INPUT_CHAR_LIMIT",
    "8000",
)
BACKGROUND_WORK_OUTPUT_CHAR_LIMIT = _positive_int_from_env(
...
CHARACTER_IDENTITY_GROWTH_ENABLED = _bool_from_env(
    "CHARACTER_IDENTITY_GROWTH_ENABLED",
    "true",
)
CHARACTER_IDENTITY_GROWTH_INFERRED_MIN_EPISODES = _bounded_int_from_env(
    "CHARACTER_IDENTITY_GROWTH_INFERRED_MIN_EPISODES",
    "3",
    minimum=2,
    maximum=8,
)
CHARACTER_IDENTITY_GROWTH_INFERRED_MIN_LOCAL_DATES = _bounded_int_from_env(
...
if (
    ...
    raise ValueError(
        "CHARACTER_IDENTITY_GROWTH_INFERRED_MIN_LOCAL_DATES cannot exceed "
        "CHARACTER_IDENTITY_GROWTH_INFERRED_MIN_EPISODES"
    )
...
CHARACTER_IDENTITY_GROWTH_PROMPT_CHAR_BUDGET = _bounded_int_from_env(
