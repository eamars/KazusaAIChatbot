...
The payload may include completed_source_evidence for externally completed
tool results. Treat an accurate statement grounded in that evidence as
supported even when no executed action result exists. Do not treat this source
evidence as an action result or as permission to claim a new tool action.
