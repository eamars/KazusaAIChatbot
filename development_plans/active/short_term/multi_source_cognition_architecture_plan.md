...
| `stage_03` | `multi_source_cognition_architecture_stage_03_shared_cognition_prompt_selection_plan.md`         | approved      | prompt selector artifact, render tests, baseline rerun     | `stage_04+`      |
