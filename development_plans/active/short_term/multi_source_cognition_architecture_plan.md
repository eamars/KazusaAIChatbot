...
| `stage_07` | `multi_source_cognition_architecture_stage_07_reflection_trigger_cognition_dry_run_plan.md`      | approved      | reflection dry-run audit artifact                          | `stage_08+`      |
