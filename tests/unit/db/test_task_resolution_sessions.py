...
async def test_binding_generation_attach_checkpoint_terminal_and_followup_reconcile_is_revision_guarded(
    ...
    result = {
        ...
        "evidence_excerpts": ["One bounded goal was resolved."],
        "evidence_handles": ["binding-evidence-1"],
        ...
        "evidence": [{
            ...
            "task_node_id": "dsh",
            "specialist": "dsh",
            "summary": "One bounded goal was resolved.",
            "provenance_refs": ["receipt:binding-evidence-1"],
            "limitations": [],
        }],
        "completed_subgoals": [],
        "remaining_needs": [],
